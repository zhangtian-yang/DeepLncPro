...
def all_proc(species, seq_len, encoding_type):
    ...
    #
    # model=torch.load('D:\\Project\\deepnc\\DeepncPro_projects\\x_181_7_4\\bestmodel_0.pkl').to(device)
    # with torch.no_grad():
    #     model.eval()
    ...
    #         test_acc=(metrics.accuracy_score(labels, pred.round()))
...
if __name__ == '__main__':
    ...
    # deepncpro(args)
    # motif分析
    # just_motif_analysis('h', 61, 5,'./MODEL/h/cnn5.pkl')
    # just_motif_analysis('m', 61, 7)

    # 2*7*7 all_process
    # all_process(['x'], [61, 101, 141, 181, 221, 261, 301], [1, 2, 3, 4, 5, 6, 7])
